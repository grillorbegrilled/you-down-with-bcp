function getOffice(now, week, feast) {
    ...
    const topMarg = getOfficeMargin1(now, feast || week);
                if (topMarg && document.getElementById("topMarg")) document.getElementById("topMarg").src = topMarg;
        ...
        switch (officeType) {
            case 1:
                ...
                if (cantMarg && document.getElementById("cantMarg")) document.getElementById("cantMarg").src = cantMarg;
