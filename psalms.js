...
const cl = `<p class="dropcap">O PRAISE God in his sanctuary: * praise him in the firmament of his power.<br>
...
//lauds
const lxiii = `<p class="dropcap">O GOD, thou art my God; * early will I seek thee.<br>
...
4 For thy loving-kindness is better than the life itself: * my lips shall praise thee.<br>
5 As long as I live will I magnify thee in this manner, * and lift up my hands in thy Name.<br>
6 My soul shall be satisfied, even as it were with marrow and fatness, * when my mouth praiseth thee with joyful lips.<br>
7 Have I not remembered thee in my bed, * and thought upon thee when I was waking?<br>
8 Because thou hast been my helper; * therefore under the shadow of thy wings will I rejoice.<br>
9 My soul hangeth upon thee; * thy right hand hath upholden me.<br>
10 These also that seek the hurt of my soul, * they shall go under the earth.<br>
11 Let them fall upon the edge of the sword, * that they may be a portion for foxes.<br>
...
const lxvii = `<p class="dropcap">GOD be merciful unto us, and bless us, * and show us the light of his countenance, and be merciful unto us;<br>
...
4 O let the nations rejoice and be glad; * for thou shalt judge the folk righteously, and govern the nations upon earth.<br>
5 Let the peoples praise thee, O God; * yea, let all the peoples praise thee.<br>
6 Then shall the earth bring forth her increase; * and God, even our own God, shall give us his blessing.<br>
...
//evensong
const xcii = `<p class="dropcap">It is a good thing to give thanks unto the LORD, * and to sing praises unto thy Name, O Most Highest;<br>
...
//evensong
const xcviii = `<p class="dropcap">O Sing unto the LORD a new song; * for he hath done marvellous things.<br>
...
//evensong
const ciii = `<p class="dropcap">Praise the LORD, O my soul; * and all that is within me, praise his holy Name.<br>
...
//general
const xix = `<p class="dropcap">THE heavens declare the glory of God; * and the firmament showeth his handy-work.<br>
...
const xlii = `<p class="dropcap">LIKE as the hart desireth the water-brooks, * so longeth my soul after thee, O God.<br>
...
4 Now when I think thereupon, I pour out my heart by myself; * for I went with the multitude, and brought them forth into the house of God;<br>
5 In the voice of praise and thanksgiving, * among such as keep holy-day.<br>
6 Why art thou so full of heaviness, O my soul? * and why art thou so disquieted within me?<br>
...
const xlvi = `<p class="dropcap">GOD is our hope and strength, * a very present help in trouble.<br>
...
const xc = `<p class="dropcap">LORD, thou hast been our refuge, * from one generation to another.<br>
...
5 As soon as thou scatterest them they are even as a sleep; * and fade away suddenly like the grass.<br>
6 In the morning it is green, and groweth up; * but in the evening it is cut down, dried up, and withered.<br>
7 For we consume away in thy displeasure, * and are afraid at thy wrathful indignation.<br>
8 Thou hast set our misdeeds before thee; * and our secret sins in the light of thy countenance.<br>
9 For when thou art angry all our days are gone: * we bring our years to an end, as it were a tale that is told.<br>
...
const lxxxiv = `<p class="dropcap">O HOW amiable are thy dwellings, * thou LORD of hosts!<br>
...
const xcvi = `<p class="dropcap">O SING unto the LORD a new song; * sing unto the LORD, all the whole earth.<br>
...
const lxii = `<p class="dropcap">MY soul truly waiteth still upon God; * for of him cometh my salvation.<br>
...
4 Their device is only how to put him out whom God will exalt; * their delight is in lies; they give good words with their mouth, but curse with their heart.<br>
5 Nevertheless, my soul, wait thou still upon God; * for my hope is in him.<br>
6 He truly is my strength and my salvation; * he is my defence, so that I shall not fall.<br>
7 In God is my health and my glory; * the rock of my might; and in God is my trust.<br>
8 O put your trust in him alway, ye people; * pour out your hearts before him, for God is our hope.<br>
9 As for the children of men, they are but vanity; the children of men are deceitful; * upon the weights they are altogether lighter than vanity itself.<br>
10 O trust not in wrong and robbery; give not yourselves unto vanity: * if riches increase, set not your heart upon them.<br>
...
const cxx = `<p class="dropcap">WHEN I was in trouble, I called upon the LORD, * and he heard me.<br>
...
const cxix1 = `<p style='text-align: center; margin-bottom: 0;'>א</p>
...
const cxix2 = `<p style='text-align: center; margin-bottom: 0;'>ב</p>
...
const cxix3 = `<p style='text-align: center; margin-bottom: 0;'>ג</p>
...
20 My soul breaketh out for the very fervent desire * that it hath alway unto thy judgments.<br>
21 Thou hast rebuked the proud; * and cursed are they that do err from thy commandments.<br>
...
const cxix4 = `<p style='text-align: center; margin-bottom: 0;'>ד</p>
...
27 Make me to understand the way of thy commandments; * and so shall I talk of thy wondrous works.<br>
...
const cxix5 = `<p style='text-align: center; margin-bottom: 0;'>ה</p>
...
37 O turn away mine eyes, lest they behold vanity; * and quicken thou me in thy way.<br>
...
const cxix6 = `<p style='text-align: center; margin-bottom: 0;'>ו</p>
...
46 I will speak of thy testimonies also, even before kings, * and will not be ashamed.<br>
...
const cxix7 = `<p style='text-align: center; margin-bottom: 0;'>ז</p>
...
const cxix8 = `<p style='text-align: center; margin-bottom: 0;'>ח</p>
...
const cxix9 = `<p style='text-align: center; margin-bottom: 0;'>ט</p>
...
69 The proud have imagined a lie against me; * but I will keep thy commandments with my whole heart.<br>
...
const cxix10 = `<p style='text-align: center; margin-bottom: 0;'>י</p>
...
const cxix11 = `<p style='text-align: center; margin-bottom: 0;'>כ</p>
...
83 For I am become like a bottle in the smoke; * yet do I not forget thy statutes.<br>
84 How many are the days of thy servant? * when wilt thou be avenged of them that persecute me?<br>
85 The proud have digged pits for me, * which are not after thy law.<br>
86 All thy commandments are true: * they persecute me falsely; O be thou my help.<br>
...
const cxix12 = `<p style='text-align: center; margin-bottom: 0;'>ל</p>
...
91 They continue this day according to thine ordinance; * for all things serve thee.<br>
92 If my delight had not been in thy law, * I should have perished in my trouble.<br>
93 I will never forget thy commandments; * for with them thou hast quickened me.<br>
...
const cxix13 = `<p style='text-align: center; margin-bottom: 0;'>מ</p>
...
99 I have more understanding than my teachers; * for thy testimonies are my study.<br>
100 I am wiser than the aged; * because I keep thy commandments.<br>
101 I have refrained my feet from every evil way, * that I may keep thy word.<br>
...
const cxix14 = `<p style='text-align: center; margin-bottom: 0;'>נ</p>
...
const cxix15 = `<p style='text-align: center; margin-bottom: 0;'>ס</p>
...
116 O stablish me according to thy word, that I may live; * and let me not be disappointed of my hope.<br>
117 Hold thou me up, and I shall be safe; * yea, my delight shall be ever in thy statutes.<br>
118 Thou hast trodden down all them that depart from thy statutes; * for they imagine but deceit.<br>
...
const cxix16 = `<p style='text-align: center; margin-bottom: 0;'>ע</p>
...
const cxix17 = `<p style='text-align: center; margin-bottom: 0;'>פ</p>
...
131 I opened my mouth, and drew in my breath; * for my delight was in thy commandments.<br>
132 O look thou upon me, and be merciful unto me, * as thou usest to do unto those that love thy Name.<br>
133 Order my steps in thy word; * and so shall no wickedness have dominion over me.<br>
134 O deliver me from the wrongful dealings of men; * and so shall I keep thy commandments.<br>
...
const cxix18 = `<p style='text-align: center; margin-bottom: 0;'>צ</p>
...
142 Thy righteousness is an everlasting righteousness, * and thy law is the truth.<br>
...
const cxix19 = `<p style='text-align: center; margin-bottom: 0;'>ק</p>
...
const cxix20 = `<p style='text-align: center; margin-bottom: 0;'>ר</p>
...
const cxix21 = `<p style='text-align: center; margin-bottom: 0;'>ש</p>
...
const cxix22 = `<p style='text-align: center; margin-bottom: 0;'>ת</p>
...
const cxxi = `<p class="dropcap">I WILL lift up mine eyes unto the hills; * from whence cometh my help?<br>
